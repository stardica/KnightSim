...
samples64: DESim64
		$(CC) $(CC_FLAGS_64) ./Samples/test.c -o ./Samples/test64 -I$(DESIM_INC) -L$(DESIM_LIB) $(LINKER_FLAGS_64)
		@echo "Built $@ successfully"
				
samples32: DESim32
		$(CC) $(CC_FLAGS_32) ./Samples/test.c -o ./Samples/test32 -I$(DESIM_INC) -L$(DESIM_LIB) $(LINKER_FLAGS_32)
		@echo "Built $@ successfully"
...
clean:
	rm -f *.o *.a ./Samples/test64 ./Samples/test32